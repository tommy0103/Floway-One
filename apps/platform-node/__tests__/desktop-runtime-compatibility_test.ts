...
test.each([
  ...
  [{ schemaVersion: 4, compatibility: { protocolVersion: 2, releaseVersion: '0.1.0' } }, 'protocol 2'],
  [{ schemaVersion: 4, compatibility: { protocolVersion: 1, releaseVersion: '0.2.0' } }, 'sidecar 0.1.0'],
