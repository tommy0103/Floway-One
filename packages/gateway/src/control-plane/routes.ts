...
import { codexOAuthAuthorizeUrl, codexOAuthExchange, codexOAuthRelayResult, codexOAuthRefresh } from './upstreams/codex.ts';
...
export const controlPlaneRoutes = new Hono<{ Variables: AuthVars }>()
  ...
  .route('/api', new Hono<{ Variables: AuthVars }>()
    ...
    .get('/upstreams/codex/oauth/relay-result', zValidator('query', codexRelayResultQuery), codexOAuthRelayResult)
